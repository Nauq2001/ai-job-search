...
> **About this copy**
>
> This is a copy of [MadsLorentzen/ai-job-search](https://github.com/MadsLorentzen/ai-job-search), shared under its MIT license (see [LICENSE](LICENSE)). All credit for the project goes to the original author. This copy contains **no personal data** - it is the plain template. Run `/setup` to fill in your own profile.
>
> Snapshot of upstream `master` as of 23 September 2026, published as a single commit rather than the full upstream history.
>
> **Bản hướng dẫn tiếng Việt: [HUONG-DAN.md](HUONG-DAN.md)** — cách cài đặt và sử dụng, dành cho người mới clone về.
